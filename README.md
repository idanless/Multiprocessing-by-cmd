...
<p><br /> to do it first all i cerate cmd the contains the bin of curl and what i need he do <br />for example:<br />@ECHO off<br />curl.exe  -o data $1 <br />timeout /T 1</p>
