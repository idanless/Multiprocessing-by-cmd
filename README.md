...
<p><br /> to do it first all i cerate cmd the contains the bin of curl and what if need to do <br />for example:<br />@ECHO off<br />curl.exe google.com<br />timeout /T 1</p>
